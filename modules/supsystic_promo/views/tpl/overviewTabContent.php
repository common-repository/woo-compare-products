	...
	<div class="supsystic-item supsystic-panel">
		<div id="containerWrapper">
			<div class="supsistic-half-side-box supsystic-border-right">
				<?php /*?><h3><?php _e('FAQ and Documentation', WCP_LANG_CODE)?></h3>
				<div class="faq-list">
				...
				<div class="server-settings">
					<h3><?php _e('Server Settings', WCP_LANG_CODE)?></h3>
			...
			<div class="supsistic-half-side-box" style="padding-left: 20px;">
				<div class="supsystic-overview-news">
					<h3><?php _e('News', WCP_LANG_CODE)?></h3>
					...
					<a href="<?php echo $this->mainLink?>" class="button button-primary button-hero" style="float: right; margin-top: 10px;">
						<i class="fa fa-info-circle"></i>
						<?php _e('All news and info', WCP_LANG_CODE)?>
					</a>
					<div style="clear: both;"></div>
				</div>
				<div class="overview-contact-form">
					<h3><?php _e('Contact form', WCP_LANG_CODE)?></h3>
					<form id="form-settings">
						<table class="contact-form-table">
							...
							<tr>
								...
								<td>
									<?php echo htmlWcp::$htmlType($fName, $htmlParams)?>
								</td>
							</tr>
							<?php }?>
							<tr>
								<th scope="row" colspan="2">
									<?php echo htmlWcp::hidden('mod', array('value' => 'supsystic_promo'))?>
									<?php echo htmlWcp::hidden('action', array('value' => 'sendContact'))?>
									<button class="button button-primary button-hero" style="float: right;">
										<i class="fa fa-upload"></i>
										<?php _e('Send email', WCP_LANG_CODE)?>
									</button>
									<div style="clear: both;"></div>
								</th>
							</tr>
					...
					<div id="form-settings-send-msg" style="display: none;">
						...
						<?php _e('Your email was sent, we will try to respond to your as soon as possible. Thank you for support!', WCP_LANG_CODE)?>
					</div>
				</div>
			</div>
			<div style="clear: both;"></div>
