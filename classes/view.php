<?php
abstract class viewWcp extends baseObjectWcp {
    /* 
     * @deprecated
     */
    protected $_tpl = WCP_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		$path = '';
		$parentModule = frameWcp::_()->getModule( $this->_code );
	...
	public function getModel($code = '') {
		return frameWcp::_()->getModule( $this->_code )->getController()->getModel($code);
	}
